    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.OneToOneField(parent_link=True, primary_key=True, serialize=False, to='arduino_dht.SensorDHT')),
